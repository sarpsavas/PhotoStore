...
{
    public class UserUpdateNameCommandHandler : IRequestHandler<UserUpdateNameCommand,Unit>
    {
        ...
        public UserUpdateNameCommandHandler(IRepository<Transaction> repositoryT,
        ...
        public async Task<Unit> Handle(UserUpdateNameCommand request, CancellationToken cancellationToken)
        {
            ...
            catch (Exception)
            {
                ...
                await _repositoryT.Add(transaction);
                await _unit.SaveChangesAsync(cancellationToken);
                throw new Exception("UserUpdateName error");
            }
        }
    }
}
