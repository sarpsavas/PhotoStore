...
{
    public class UserUpdateEMailCommandHandler : IRequestHandler<UserUpdateEMailCommand,Unit>
    {
        ...
        public UserUpdateEMailCommandHandler(IRepository<Transaction> repositoryT,
        ...
        public async Task<Unit> Handle(UserUpdateEMailCommand request, CancellationToken cancellationToken)
        {
            ...
            catch (Exception)
            {
                ...
                await _repositoryT.Add(transaction);
                await _unit.SaveChangesAsync(cancellationToken);
                throw new Exception("UserUpdateEMail error");
            }
        }
    }
}
